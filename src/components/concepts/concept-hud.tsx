        ...
        <AnimatePresence>
          {!hintSeen ? (
            <motion.p
              ...
              className="pointer-events-none text-[11px] uppercase tracking-[0.22em] text-muted-foreground"
            >
...
function BlueprintToggle({
  ...
  return (
    <button
      ...
      className={[
        "pointer-events-auto inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-[11px] uppercase tracking-[0.18em] backdrop-blur-md transition-colors",
        enabled
...
function BlueprintOverlay({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto absolute bottom-4 left-4 max-w-[20rem] rounded-xl border border-accent/30 bg-black/55 p-3 backdrop-blur-md sm:bottom-6 sm:left-6">
