...
const rawBodies: CelestialBody[] = [
  ...
  },
  {
    ...
    moons: { count: 27, notable: ["Titania", "Oberon", "Miranda", "Ariel", "Umbriel"] },
    comparisonToEarth: {
      gravity: 0.886,
      radius: 3.981,
      mass: 14.54,
  ...
  },
  {
    ...
    moons: { count: 14, notable: ["Triton", "Nereid", "Proteus"] },
    comparisonToEarth: {
      gravity: 1.137,
      radius: 3.865,
      mass: 17.15,
