      ...
      {body.id !== "earth" ? (
        <section className="mt-16">
          <SectionHeading
            ...
            description="A quick-read comparison across gravity, size, mass, and time."
          />
          <div className="mt-8 grid gap-px rounded-2xl border border-border bg-border/70 sm:grid-cols-2 md:grid-cols-5 overflow-hidden">
            {[
              ...
              { label: "Day length", ratio: body.comparisonToEarth.dayLength },
              { label: "Year length", ratio: body.comparisonToEarth.yearLength },
            ].map((row) => (
